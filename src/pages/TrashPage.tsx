...
import { Note as NoteType, restoreNote } from "../store/slices/notesSlice";
...
export const TrashPage = () => {
  ...
  const deleteAll = () => console.log("Delete all notes"); // Placeholder for deleteAll function, replace with actual implementation
...
const EmptyTrash = () => (
  <div className="flex flex-col items-center justify-center h-full text-center">
    ...
    <p className="text-sm text-gray-500">Видалені нотатки автоматично зникнуть через 7 днів</p>
  </div>
);
